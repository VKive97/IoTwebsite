  ...
  header.innerHTML = `
    ...
    <div id="mega-solutions" class="mega-menu">
      <div class="d-flex gap-4 px-4 py-4" style="max-width:1280px;margin:auto">
        <div class="flex-grow-1">
          <div class="row g-4">
            <div class="col-6 col-md-3"><a href="/solutions/fleet-management/" class="mega-product-card d-block"><img src="/images/solution-fleet-management.png" alt="Fleet Management"><p class="fw-semibold small text-dark mt-2 card-name">Fleet Management</p><p class="text-muted" style="font-size:.7rem">Complete fleet operations.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/fleet-tracking/" class="mega-product-card d-block"><img src="/images/solution-fleet-tracking.png" alt="Fleet Tracking"><p class="fw-semibold small text-dark mt-2 card-name">Fleet Tracking</p><p class="text-muted" style="font-size:.7rem">Real-time fleet visibility.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/driver-management/" class="mega-product-card d-block"><img src="/images/solution-driver-management.png" alt="Driver Management"><p class="fw-semibold small text-dark mt-2 card-name">Driver Management</p><p class="text-muted" style="font-size:.7rem">Driver safety &amp; performance.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/asset-management/" class="mega-product-card d-block"><img src="/images/solution-asset-management.png" alt="Asset Management"><p class="fw-semibold small text-dark mt-2 card-name">Asset Management</p><p class="text-muted" style="font-size:.7rem">Fleet &amp; operational assets.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/maintenance-management/" class="mega-product-card d-block"><img src="/images/solution-maintenance-management.png" alt="Maintenance Management"><p class="fw-semibold small text-dark mt-2 card-name">Maintenance Management</p><p class="text-muted" style="font-size:.7rem">Fleet &amp; asset maintenance.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/dispatch-management/" class="mega-product-card d-block"><img src="/images/solution-dispatch-management.png" alt="Dispatch Management"><p class="fw-semibold small text-dark mt-2 card-name">Dispatch Management</p><p class="text-muted" style="font-size:.7rem">Intelligent workforce dispatch.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/inventory-management/" class="mega-product-card d-block"><img src="/images/solution-inventory-management.png" alt="Inventory Management"><p class="fw-semibold small text-dark mt-2 card-name">Inventory Management</p><p class="text-muted" style="font-size:.7rem">Field inventory &amp; assets.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
            <div class="col-6 col-md-3"><a href="/solutions/fleet-security/" class="mega-product-card d-block"><img src="/images/solution-fleet-security.png" alt="Fleet Security"><p class="fw-semibold small text-dark mt-2 card-name">Fleet Security</p><p class="text-muted" style="font-size:.7rem">Security operations.</p><span class="small text-secondary">Learn More &rarr;</span></a></div>
          </div>
        </div>
    ...
    <div id="mobile-menu" class="mob-panel d-lg-none">
      ...
      <div class="mob-view-stack">
        ...
        <div class="mob-view mob-view-sub" data-mob-view="solutions">
          ...
          <div class="mob-sub-content">
            <div class="row g-3">
              <div class="col-6"><a href="/solutions/fleet-management/" class="mob-product-card"><img src="/images/solution-fleet-management.png" alt="Fleet Management"><p class="mob-product-name">Fleet Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/fleet-tracking/" class="mob-product-card"><img src="/images/solution-fleet-tracking.png" alt="Fleet Tracking"><p class="mob-product-name">Fleet Tracking</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/driver-management/" class="mob-product-card"><img src="/images/solution-driver-management.png" alt="Driver Management"><p class="mob-product-name">Driver Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/asset-management/" class="mob-product-card"><img src="/images/solution-asset-management.png" alt="Asset Management"><p class="mob-product-name">Asset Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/maintenance-management/" class="mob-product-card"><img src="/images/solution-maintenance-management.png" alt="Maintenance Management"><p class="mob-product-name">Maintenance Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/dispatch-management/" class="mob-product-card"><img src="/images/solution-dispatch-management.png" alt="Dispatch Management"><p class="mob-product-name">Dispatch Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/inventory-management/" class="mob-product-card"><img src="/images/solution-inventory-management.png" alt="Inventory Management"><p class="mob-product-name">Inventory Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/solutions/fleet-security/" class="mob-product-card"><img src="/images/solution-fleet-security.png" alt="Fleet Security"><p class="mob-product-name">Fleet Security</p><span class="mob-product-link">Learn More</span></a></div>
            </div>
            <div class="mob-sub-links">
        ...
        <div class="mob-view mob-view-sub" data-mob-view="industries">
          ...
          <div class="mob-sub-content">
            <div class="row g-3">
              <div class="col-6"><a href="/industries/transportation/" class="mob-product-card"><img src="/images/industry-transportation.png" alt="Transportation"><p class="mob-product-name">Transportation</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/industries/waste-management/" class="mob-product-card"><img src="/images/industry-waste-management.png" alt="Waste Management"><p class="mob-product-name">Waste Management</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/industries/food-services-fmcg/" class="mob-product-card"><img src="/images/industry-food-services-fmcg.png" alt="Food Services &amp; FMCG"><p class="mob-product-name">Food Services &amp; FMCG</p><span class="mob-product-link">Learn More</span></a></div>
              <div class="col-6"><a href="/industries/logistics-supply-chain/" class="mob-product-card"><img src="/images/industry-logistics-supply-chain.png" alt="Logistics &amp; Supply Chain"><p class="mob-product-name">Logistics &amp; Supply Chain</p><span class="mob-product-link">Learn More</span></a></div>
            </div>
            <div class="mob-sub-links">
